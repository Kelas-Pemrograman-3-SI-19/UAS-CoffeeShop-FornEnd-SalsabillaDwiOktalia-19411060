...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'datacoffee', name: 'dataCoffee', component: () => import('pages/admin/DataCoffee.vue') },
      { path: 'formedit/:id', name: 'formEditCoffee', component: () => import('pages/admin/FormEdit.vue') }
    ]
  },
  {
    path: '/user',
