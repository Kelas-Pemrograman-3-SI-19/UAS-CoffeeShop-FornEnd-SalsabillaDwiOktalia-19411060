                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <div class="row q-pt-md q-pb-md">
                    <div class="col-md-8 offset-2">
                        <q-img src="https://www.ledgerinsights.com/wp-content/uploads/2019/10/coffee.2-810x524.jpg"></q-img>
                    </div>
                  </div>
                </div>
              <div class="col-md-6">
                <q-card-section>
                  <div class="text-h4">Coffee Shop</div>
                  <div class="text-h8">Login Akun Anda</div>
                </q-card-section>
                <q-form
                @submit="login"
                >
