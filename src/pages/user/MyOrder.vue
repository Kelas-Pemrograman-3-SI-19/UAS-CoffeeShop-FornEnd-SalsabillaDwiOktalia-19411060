          ...
          <template v-slot:body="props">
            <q-tr :props="props">
              <q-td key="namaCoffee" :props="props">
                {{ props.row.dataCoffee[0].namaCoffee }}
              </q-td>
              ...
              <q-td key="aksi" :props="props">
                <q-btn :disable="props.row.status !== 1" label="Terima Barang" @click="confirm(props.row._id)" class="q-ml-sm" color="green" unelevated/>
              </q-td>
            </q-tr>
          </template>
        </q-table>
...
export default {
  ...
  data () {
    return {
      columns: [
        { name: 'namaCoffee', align: 'center', label: 'Nama Coffee', field: 'namaCoffee', sortable: true },
